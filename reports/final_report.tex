...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|l|X|}
        ...
        \hline
        Final Project Report (this document) & \url{https://github.com/senaoz/SWE-574/tree/main/final-deliverables}
        \\
        \hline
        ...
        \hline
        Android APK                          & \url{https://github.com/senaoz/SWE-574/tree/main/apk}                                        \\
        \hline
        Demo Video                           & \textit{\url{https://drive.google.com/file/d/1BxsD2vjVa1TiVinZe4NU7vNgSqXYdloy/view?usp=sharing}} \\
        \hline
        ...
        \hline
        AI Use Declaration                   & \url{https://github.com/senaoz/SWE-574/blob/main/AI_USAGE.md}
        \\
        \hline
    \end{tabularx}
\end{table}
...
\textit{\url{https://drive.google.com/file/d/1BxsD2vjVa1TiVinZe4NU7vNgSqXYdloy/view?usp=sharing}}
...
\url{https://github.com/senaoz/SWE-574/wiki/Web-Interfaces}
...
\url{https://github.com/senaoz/SWE-574/wiki/App-Interfaces}
...
\url{https://github.com/senaoz/SWE-574/blob/main/final-deliverables/individual_contributions.md}

% =========================================================
\chapter{Honor Code Declarations}
% =========================================================
...
\newcommand{\honordeclaration}{%
\begin{tcolorbox}[
    colback=white,
    colframe=blue!50!black,
    fonttitle=\bfseries,
    title=Honor Code Declaration,
    arc=4pt,
    boxrule=1.5pt,
...
\begin{itemize}
    \item I am registered for SWE 574 during the Spring 2026 semester.
    \item All submitted materials have been prepared by myself and/or my project team.
    \item Any permitted external assistance or reused software has been explicitly disclosed.
    \item I understand that plagiarism and unauthorized code reuse are academic integrity violations.
\end{itemize}

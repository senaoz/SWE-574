...
\large
Related to the submission of all the project deliverables for the SWE 574 Spring 2026 semester project reported in this report, we \textbf{Ay\c{s}enur \"{U}nal, Sena \"{O}z, Kenan Altunba\c{s}, and Yusuf Sava\c{s}} declare that:

\begin{itemize}[leftmargin=0.5cm]
    \item We are students in the Software Engineering MS program at Boğaziçi University and are registered for SWE 574 course during the Spring 2026 semester.
    ...
    \item We have used AI tools (Claude, ChatGPT, Gemini etc.) as development assistants, which we have fully disclosed in the AI Use Declaration document.
...
\begin{center}
    \begin{tabular}{p{6cm} p{6cm}}
        \textbf{Ay\c{s}enur \"{U}nal} & \textbf{Sena \"{O}z}     \\[1.5cm]
